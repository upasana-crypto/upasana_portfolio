...
export interface Config {
  ...
  collectionsSelect: {
    ...
    technical_posts: TechnicalPostsSelect<false> | TechnicalPostsSelect<true>;
...
export interface ArchiveBlock {
  ...
  relationTo?: ('posts' | 'technical_posts') | null;
  categories?: (string | Category)[] | null;
  limit?: number | null;
  selectedDocs?:
    | (
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "technical_posts".
 */
export interface TechnicalPost {
  ...
  relatedPosts?: (string | TechnicalPost)[] | null;
  categories?: (string | Category)[] | null;
  meta?: {
    title?: string | null;
    /**
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "technical_posts_select".
 */
export interface TechnicalPostsSelect<T extends boolean = true> {
  title?: T;
  heroImage?: T;
  content?: T;
  relatedPosts?: T;
...
export interface Homepage {
  ...
  mainTitle: string;
  /**
   * Optional description text that appears below the main title.
   */
  mainDescription?: string | null;
  /**
   * This image will be used as the background for the entire homepage.
   */
  ...
  sections?:
    | {
        ...
        /**
         * Hex code or Tailwind class (e.g., #FFFFFF, text-white)
         */
        textColor: string;
        /**
